...
require (
	...
	github.com/ktenzer/temporal-trivia v0.0.0-20230420162443-d6563fce55a1
	go.temporal.io/sdk v1.22.2
	go.temporal.io/sdk/contrib/tools/workflowcheck v0.0.0-20230522210200-febeb48c453a
)
